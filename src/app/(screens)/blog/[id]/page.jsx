...
export default function page() {
  return (
    <>
      <div className=" font-['Archivo'] pt-52">
        ...
        {/* IMAGE */}
        <Image src="/images/blog/blog-detail.png" alt="Blog Image" width={1000} height={1000} className="w-full" />



        {/* CONTENT */}
        <div className="2xl:max-w-[1440px] w-[90%] mx-auto flex items-center justify-end font-['Archivo']">
          <div className="px-6 py-12  space-y-12 lg:max-w-[80%] xl:max-w-[70%] 2xl:max-w-[65%]">
            ...
            <div className="space-y-8">
              <h2 className="text-[36px] font-medium max-w-[80%] 2xl:max-w-[60%] leading-[42px] font-['Archivo']">Where It All Started — The Early Days of Personalization</h2>
            ...
            <div className="space-y-8">
              <h2 className="text-[36px] font-medium leading-[42px] font-['Archivo']">The Rise of Data and Recommendation Engines</h2>
              <div className="space-y-5">
                <p className="text-lg text-[#6D6E76] font-medium font-['Archivo']">
            ...
            <div>
              <h2 className="text-[36px] font-medium mb-6 leading-[42px] font-['Archivo']">

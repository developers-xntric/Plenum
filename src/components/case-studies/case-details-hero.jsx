          ...
          <div className="container mx-auto px-6 md:px-8 xl:px-12 2xl:px-16">
            <div className="max-w-[1440px] mx-auto">
              ...
              <div className="max-w-3xl xl:max-w-4xl">
                <h1 className="text-[30px] md:text-5xl lg:text-6xl xl:text-7xl tracking-[-1px] leading-[1.15] md:tracking-[-2.954px] md:leading-[1.1] text-white mb-6 font-semibold font-['Chakra'] md:w-[600px]">
                  Turn soft solutions into real results
                </h1>
  
                <p className="text-white max-w-[480px] text-[15px] md:text-xl font-normal font-['Archivo'] leading-relaxed">

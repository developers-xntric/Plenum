        ...
        <div className='bg-cover bg-no-repeat' style={{ backgroundImage: "url('/casestudy/casestudy-hero1.png')" }}>
            <div className="2xl:max-w-[1440px] w-[85%] mx-auto space-y-20 py-16 xl:py-24 h-screen 2xl:h-[900px]">
                ...
                <div className="container mx-auto px-4 pt-32 md:pt-40">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl text-white mb-4 max-w-xl font-semibold font-['Chakra'] ">
                        Turn soft solutions into real results
                    </h1>

                    <p className="text-white opacity-60 max-w-[480px] text-lg md:text-xl font-normal font-['Archivo'] ">

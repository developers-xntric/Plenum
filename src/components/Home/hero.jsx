        ...
        <section className='relative z-30 bg-black overflow-hidden flex flex-col'>
            ...
            <div className='flex w-[750px] xl:w-[950px] 2xl:w-[980px] mx-auto justify-center h-screen mt-40'>
                <div className='w-full mx-auto flex flex-col gap-4'>
                    ...
                    <p className='font-["Archivo"] font-normal text-sm lg:text-lg xl:text-xl text-center text-white'>Plenum isn’t just another ERP provider; we embed AI into your systems to deliver actionable insights and smarter decision-making capabilities.</p>
                </div>
            </div>
            {/* //video */}
            ...
            <div className='flex justify-center items-center flex-col text-center'>
                <div className="w-[680px] p-[0.8px] h-14 bg-white/5 rounded-xl  bg-gradient-to-l from-red-500 via-orange-700/80 to-red-300 outline-red-500 inline-flex justify-start items-center">

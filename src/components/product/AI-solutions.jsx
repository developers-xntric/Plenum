        ...
        <section className='relative font-["Archivo"] bg-[#EFEFEF]'>
            <div className={` `}>
                <div className={`flex 2xl:items-center justify-between`}>
                    <div className='space-y-7'>
                        <div className="2xl:max-w-[1440px] lg:w-[82%] xl:w-[65%] 2xl:w-[50%] mx-auto flex flex-col py-12">
                            ...
                            <div className='relative flex items-center justify-start'>
                                <h2 className='text-[36px] text-secondary font-medium home-section-headings leading-10 lg:max-w-[80%] xl:max-w-[90%] 2xl:max-w-[90%]   '>Create Comprehensive
                                    AI Solutions Without Coding</h2>
                            </div>
                            <p className='text-secondary font-["Archivo"] lg:max-w-[85%] xl:max-w-[99%] 2xl:max-w-[90%] my-4 opacity-75'>Accelerate digital transformation with Momentum AI by PlenumTech — a no-code platform that streamlines data ingestion, ML model training, deployment, and workflow automation.</p>
                    ...
                    <div className=' flex justify-center items-center w-[80%] 2xl:w-[50%] '>

        ...
        <section className=" py-16">
            <div className="2xl:max-w-[1440px] mx-auto w-[90%]">
                <div className="text-center mb-8">
                    <h2 className="text-[50px] leading-[50px] mx-auto max-w-[55%] xl:max-w-[45%] font-['Archivo'] text-secondary font-semibold home-section-headings mb-6">Start Small and Scale Big
                        with Momentum AI</h2>

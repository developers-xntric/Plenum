...
const ProductHero = ({ bgImage, isLogo = true, heading, heading_className }) => {
    return (
            ...
            <div className="2xl:max-w-[1440px] h-full w-[90%] mx-auto space-y-20 py-16 xl:pt-36">
                ...
                <div className='w-full h-full flex mt-10 xl:mt-0'>
                    ...
                    <div className="flex flex-col justify-end h-full items-start w-[530px] xl:w-[730px]">
                        <h1 className={`md:text-[60px] xl:text-[90px] font-["Chakra"] font-[600] text-primary flex flex-col gap-2 md:leading-12 xl:leading-20 ${heading_className}`} dangerouslySetInnerHTML={{ __html: heading ? heading : "Momentum AI" }}></h1>

...
// import { Menu, ChevronRight, ChevronDown, X, MoveDown, MoveUp, ArrowRight, ArrowDown } from "lucide-react"
...
//         Services: true,
//         "ERP consulting and implementation": true,
//         "Oracle ERP Solutions": true,
//         "Microsoft Dynamics ERP Solutions": true,
//     })
...
//                             link: "/services/erp-consulting/oracle",
//                             subItems: [
//                                 { name: "NetSuite", link: "/services/erp-consulting/oracle/netsuite" },
//                                 { name: "Fusion Cloud", link: "/services/erp-consulting/oracle/fusion-cloud" },
//                             ],
//                         },
//                         {
//                             name: "Microsoft Dynamics ERP Solutions",
//                             link: "/services/erp-consulting/microsoft",
//                             subItems: [
//                                 { name: "Business Central", link: "/services/erp-consulting/microsoft/business-central" },
//                                 { name: "Finance and Operations", link: "/services/erp-consulting/microsoft/finance-operations" },
//                             ],
//                         },
//                     ],
//                 },
//                 { name: "Managed Cloud Services", link: "/services/managed-cloud" },
//                 { name: "AI consulting, governance and implementation", link: "/services/ai-consulting" },
//                 { name: "Digital Experiences", link: "/services/digital-experiences" },
//             ],
//         },
...
//                                         <ArrowDown size={16} className="text-[#FF6035]" />
//                                     ) : (
//                                         <ArrowRight size={16} className="text-[#FF6035]" />
//                                     )}
//                                 </span>
//                             )}
//                             {!item.subItems && <span className="w-4 mr-1"></span>}
//                             <Link href={item.link} className="text-[15px]">
//                                 {item.name}
//                             </Link>
//                         </div>
//                         {expandedItems[item.name] && renderSubItems(item.subItems, level + 1)}
//                     </li>
//                 ))}
//             </ul>
//         )
...
//                                     <Link href={item.link} className="text-[16px] font-medium">
//                                         {item.name}
//                                     </Link>
//                                     {item.subItems && (
...
//                                         </span>
//                                     )}
//                                     {!item.subItems && <ArrowRight size={18} />}
//                                 </div>
//                                 {expandedItems[item.name] && renderSubItems(item.subItems)}
//                             </li>
//                         ))}
//                     </ul>
//                 </div>
...
const MobileNav = () => {
  ...
  const menuItems = [
    { name: "Home", link: "/" },
    {
      ...
      subItems: [
        ...
        {
          name: "AI consulting, governance and implementation",
          link: "/service",
        },
        {
  ...
  return (
    <div className="relative md:hidden z-[999]">
      ...
      <div
        className={`fixed top-0 left-0 w-full h-full bg-white overflow-y-auto transition-transform duration-500 ease-in-out z-50 ${

    ...
    return (
        <section className='relative font-["Archivo"] bg-[#282526]'>
            <div className='max-w-[90%] xl:max-w-[75%] 2xl:max-w-[55%]  mx-auto text-center py-16  '>
                <h2 className='text-[30px] lg:text-[50px] leading-[35px] lg:leading-[50px] text-white lg:w-[54%] 2xl:w-[65%] mx-auto'>{blackSection.heading}</h2>
                <p className='text-[15px] lg:text-[18px] text-[#FFF] mt-6 opacity-60 lg:w-[80%] mx-auto'>{blackSection.para}</p>

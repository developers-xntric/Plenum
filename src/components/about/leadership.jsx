        ...
        <section className="2xl:max-w-[1440px] w-[90%] mx-auto space-y-20 pb-16 font-['Archivo']">
            ...
            <div className="flex items-center justify-between w-full mx-auto space-x-10 h-[400px]">
                ...
                <div className="w-1/2 h-full flex flex-col justify-between">
                    ...
                    <div>
                        <h3 className="text-[30px] font-medium text-secondary tracking-tighter">Aasim Shaikh</h3>
                        <p className="text-[18px] text-seconday opacity-60 font-normal mt-2">Group CEO</p>
                    </div>
                </div>
            </div>
        </section>

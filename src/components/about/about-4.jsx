...
export default function About4() {
  return (
    <section className="bg-[#1E1E1E] text-white py-20 px-4 lg:px-16 xl:px-24 2xl:px-32 overflow-hidden relative">
      {/* Vision Section */}
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between mb-32 relative">
      ...
      {/* Mission Section */}
      <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between relative">
        {/* Left side - Mission Content */}
        <div className="w-full lg:w-1/2">
          <h2 className="text-5xl lg:text-6xl xl:text-7xl font-light mb-8 mt-10 lg:mt-0">

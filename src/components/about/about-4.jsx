...
export default function About4() {
  return (
    <section className="bg-[#1E1E1E] font-['Archivo'] py-20  relative">
      <div className="2xl:max-w-[1440px] w-[85%] lg:w-[90%] mx-auto">
        <div className="flex flex-col lg:flex-row items-center text-center lg:text-start  lg:justify-evenly mb-16 lg:mb-20 relative">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-[15px] lg:text-[16px] 2xl:max-w-[70%] leading-relaxed text-[#FFFFFF] opacity-60 lg:w-[85%]">
        ...
        {/* Mission Section */}
        <div className="flex flex-col lg:flex-row items-center text-center lg:text-start  justify-between  relative mx-auto">
      ...
      <div className="w-full md:w-[40%] lg:w-1/3 relative flex md:justify-center lg:justify-start mx-auto">
        <div className="relative md:mx-auto flex justify-center">
          ...
          <Image
            ...
            width={700}
            height={700}
            className="w-[200px] md:w-[240px] lg:w-[277px] h-full object-cover"
            style={{ userSelect: "none" }}
            unoptimized
          />
        </div>

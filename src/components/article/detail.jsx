...
const ArticleDetail = () => {
    return (
        <section className='pt-40 font-["Archivo"]'>
            <div className='md:max-w-[90%] mx-auto 2xl:max-w-[1440px]'>
                <div className="flex flex-col md:flex-row">
                    <div className="border-r border-gray-200 px-6 lg:block hidden ">
                        <div className="mb-2 border-l-2 border-[#FF6035] pl-2">
                            <h2 className="text-[16px] font-semibold text-gray-900">Case Study</h2>
                        </div>
                        <Tabs defaultValue="1" orientation="vertical" className="w-full font-medium text-[#B2B2B2] ">

                            <TabsList className="flex flex-col items-start font-semibold space-y-1 bg-transparent h-auto">
                                <TabsTrigger
                                    value="1"
                                    className="w-full justify-start px-0 font-semibold text-[#B2B2B2] data-[state=active]:bg-transparent data-[state=active]:shadow-none text-left"
                                >
                                    Diving Deeper
                                </TabsTrigger>
                                <TabsTrigger
                    ...
                    <div className='2xl:max-w-[1440px] max-w-[90%] mx-auto'>
                        ...
                        <div className="flex-1 md:px-7">
                            <div className="mb-6">
                                <p className="text-[14px] md:text-[17px] text-[#636363] font-medium mb-2">March 9, 2023</p>
                                <h2 className="text-[30px] md:text-[40px] font-semibold mb-6 leading-[34px] md:leading-[48px] xl:max-w-[75%] 2xl:max-w-[70%] ">
                                ...
                                <div className="prose max-w-none xl:max-w-[70%] ">
                                    <p className="text-[#6D6E76] text-[15px] md:text-[18px] mb-6">
                                    ...
                                    <h2 className="text-[25px] md:text-[30px] font-semibold mt-10 mb-6">Where It All Started — The Early Days of Personalization</h2>

                                    <p className="text-[#6D6E76] text-[17px] md:text-[18px] mb-6">
                                ...
                                <div className="prose max-w-none xl:max-w-[70%] ">
                                    ...
                                    <h2 className="text-[25px] md:text-[30px] font-bold mt-10 mb-6">Where It All Started — The Early Days of Personalization</h2>

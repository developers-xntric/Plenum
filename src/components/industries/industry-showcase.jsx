  ...
  return (
    <div className="2xl:max-w-[1440px] md:block hidden mx-auto w-[93%] xl:w-[95%] py-10">
      ...
      {isTabs ? <div className="relative mb-10 w-[85%] mx-auto">
        ...
        >
          <div className="flex gap-3 items-center ralative">
            {tabs.map((tab) => (
              <button
                key={tab}
      ...
      <div className="flex gap-4 justify-between">
        ...
        <div className="relative w-[24%]">
          <div className="bg-white overflow-hidden h-[512px]">
            <Image
          ...
          <div className="mt-2 flex gap-4 items-center">
            <span className="text-[21.419px] text-[#232522] font-medium">HorizonGrow</span>
        ...
        <div className="flex flex-col w-[50%]">
          ...
          <div className="relative mx-auto">
            <div className="bg-white rounded-lg overflow-hidden shadow-sm w-[584.037px] h-[332.957px]">
              <Image
            ...
            <div className="mt-2 flex gap-4 items-center">
              <span className="text-[21.419px] text-[#232522] font-medium">OrionEdge Technologies</span>
              <Image src={"/industries/arrow_i.svg"} alt="Arrow" width={15} height={15} />
            </div>
          </div>

          {/* CrimsonBay Energy */}
          <div className="flex w-[584.037px] gap-8 mx-auto mt-16">
            <div className="relative">
              <div className="bg-white rounded-lg overflow-hidden w-[262.691px] shadow-sm h-[276.048px]">
                <Image
              ...
              <div className="mt-2 flex gap-4 items-center">
                <span className="text-[21.419px] text-[#232522] font-medium">CrimsonBay Energy</span>
                <Image src={"/industries/arrow_i.svg"} alt="Arrow" width={15} height={15} />
              </div>
            </div>
            <div className="relative">
              <div className="bg-white rounded-lg overflow-hidden w-[280.5px] shadow-sm h-[228.556px]">
                <Image
        ...
        <div className="flex flex-col gap-8 w-[26%]">
          ...
          <div className="col-span-12 md:col-span-4 relative">
            <div className="bg-white rounded-lg overflow-hidden shadow-sm w-[309.388px] h-[218.862px]">
              <Image
            ...
            <div className="mt-2 flex gap-4 items-center">
              <span className="text-[21.419px] text-[#232522] font-medium">ZenithMed</span>
              <Image src={"/industries/arrow_i.svg"} alt="Arrow" width={15} height={15} />
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-4 relative">
            <div className="bg-white rounded-lg overflow-hidden shadow-sm w-[309.388px] h-[335.567px]">
              <Image
            ...
            <div className="mt-2 flex items-center">
              <span className="text-[21.419px] text-[#232522] font-medium">VertaTech</span>
              <Image src={"/industries/arrow_i.svg"} alt="Arrow" width={15} height={15} />
            </div>
          </div>
        </div>

...
const Hero = () => {
    return (
        <section className='relative z-30 bg-black overflow-hidden flex flex-col'>
            ...
            <div className='flex w-[90%] xl:w-[950px] 2xl:w-[980px] mx-auto justify-center h-screen mt-40'>
                <div className='w-full mx-auto flex flex-col gap-4'>
                    <h1 className='w-full lg:max-w-[80%] 2xl:max-w-[80%] mx-auto text-white 2xl:text-[75px] text-[40px] font-semibold xl:text-[70px] leading-[50px] xl:leading-[71px] font-["Chakra"] text-center'>ERP with <span className='text-primary'>Intelligence</span> at Its Core</h1>
                    <p className='font-["Archivo"] font-normal text-[16px] lg:text-lg xl:text-[19px] text-center text-white'>Plenum isn’t just another ERP provider; we embed AI into your systems to deliver actionable insights and smarter decision-making capabilities.</p>
                </div>
            </div>
            {/* //video */}
            <div className='w-full absolute lg:top-48  2xl:top-20 -z-20 opacity-100 left-1/2 -translate-x-1/2'>
                <video
                    src='/home/hero.webm'
                    height={1000}
                    width={1000}
            ...
            <div className='flex justify-center items-center flex-col text-center'>
                <AnimatedBorder>
                    <div className="hidden w-[680px] p-[0.8px] h-14 bg-white/5 rounded-xl   md:inline-flex justify-start items-center">
                ...
                <div className='hidden md:flex mt-10 2xl:max-w-[1440px] pb-10 leading-[15px] w-[1000px] mx-auto justify-center items-center gap-8 flex-wrap'>
                    {
                        links.map((ele, ind) => {
                            return (
                ...
                <div className='w-full bg-[#1a1a1a] py-3 flex justify-center items-center gap-10'>
                    ...
                    <div className='bg-gradient-to-l p-[0.7px] xl:p-[0.5px]  from-red-500 via-orange-700/80 to-red-300 rounded-[8px]'>
                        <Button className='font-["Archivo"] hover:bg-[#FF6035] hover:transition-colors ease-in-out duration-300 bg-zinc-900 xl:px-8 px-8 xl:py-3 py-2 text-white font-primary t`ext-[14px]' text="Lets Talk" link='/' />
                    </div>
                </div>
            </div>
        </section>

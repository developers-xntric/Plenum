...
const Hero = () => {
    return (
        <section className='relative z-30 bg-black overflow-hidden flex flex-col'>
            <div className='hidden md:block absolute top-0 -translate-x-1/2 left-1/2 w-full -z-15 '>
            ...
            <div className='flex w-full md:w-[100%] lg:w-[85%] xl:w-[80%] 2xl:w-[1200px] mx-auto justify-center h-[80vh] md:h-screen mt-32 md:mt-40'>
                <div className='w-full mx-auto flex flex-col gap-4'>
                    ...
                    <p className='font-["Archivo"] font-normal text-[14px] lg:text-lg xl:text-[19px] text-center text-white 2xl:max-w-[73%] lg:max-w-[77%] max-w-[92%] mx-auto '>We build intelligent enterprise ecosystems by combining AI, data engineering, ERP, and digital experiences -empowering your businesses to work smarter, move faster, and stay connected seamlessly.</p>
                </div>
            </div>
            {/* //video */}
            ...
            <div className='flex justify-center items-center flex-col text-center'>
                ...
                <div className='w-full bg-[#1a1a1a] py-3 flex justify-center items-center gap-10'>
                    ...
                    <div className='bg-gradient-to-l relative right-3 p-[1.4px] xl:p-[1.2px]  from-red-500 via-orange-700/80 to-red-300 rounded-[8px]'>
                        <Button className='font-["Archivo"] hover:bg-[#FF6035] hover:transition-colors ease-in-out duration-300 bg-zinc-900 xl:px-8 px-4 w-[100px] md:w-full xl:w-full md:px-8 md:py-2 py-2 text-white font-primary text-[10px] md:text-[14px]' text="Lets Talk" link='/contact' />
                    </div>
                </div>
            </div>
        </section>

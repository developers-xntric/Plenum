...
const industries = [
  {
    ...
    description:
      "Modernized a retail group's operations using Microsoft Dynamics 365 F&O for finance, procurement, HR, and POS integration.",
  ...
  },
  {
    ...
    description:
      "Launched an ERP-integrated eCommerce store with inventory sync, customer segmentation, delivery tracking, and loyalty logic.",
  ...
  },
  {
    ...
    description:
      "Designed and launched a fully functional, mobile-first Learning Management System with automated grading, video lessons, and parent insights.",
...
export default function IndustryShowcase() {
  ...
  // Sync main carousel with currentIndex (for dots and navigation)
  useEffect(() => {
    if (!emblaApiMain) return;

    const onSelect = () => {
      console.log("Main carousel selected slide:", emblaApiMain.selectedScrollSnap());
  ...
  return (
    <div className="2xl:max-w-[1440px] md:max-w-[90%] mx-auto md:rounded-3xl font-['Archivo'] md:mb-20 bg-secondary text-white overflow-hidden">
          ...
          <div className="ticker-content">
            {[...industries, ...industries].map((industry, index) => (
              <button
                ...
                className="px-4 2xl:px-10 py-6 whitespace-nowrap text-[17px] text-white"
                onClick={() => {
                  console.log("Navigating to:", index % industries.length);
                  if (emblaApiMain) emblaApiMain.scrollTo(index % industries.length);
                }}
              >
                {industry.industry}
              </button>
      ...
      <div className="relative">
        <div className="embla overflow-hidden" ref={emblaRefMain}>
          <div className="embla__container flex max-w-[97%] mx-auto gap-2">
            {industries.map((industry) => (
              <div key={industry.id} className="embla__slide flex-[0_0_100%] min-w-0">
                <div className="py-8 px-5 md:px-0 md:p-12">
                  <div className="text-gray-400 md:text-left text-center">Industry</div>
                  <div className="text-[#FF6035] text-[24px] md:text-[30px] md:text-left text-center leading-[30px] md:leading-[40px] font-semibold mb-6">
                    {industry.industry}
                  </div>
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-1/2 flex flex-col justify-between">
                      <div>
                        <h3 className="text-[18px] md:text-[28px] text-[#FFFFFF] leading-[25px] md:leading-[40px] font-semibold mb-3">
                          {industry.name}
                        </h3>
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="mt-6 md:mt-auto">
                            <a
                              ...
                              className="text-[#FF6035] text-[17px] flex items-center group"
                            >
                              View Project
            ...
            {industries.map((_, index) => (
              <button
                ...
                onClick={() => {
                  ...
                  emblaApiMain && emblaApiMain.scrollTo(index);
                }}
                className={cn(

    ...
    <div className="text-center py-16 bg-white">
      ...
      <div className="2xl:max-w-[1440px] w-[90%] mx-auto space-y-10 md:space-y-16">
        ...
        <div className="space-y-6">
          <h2 className={`text-[30px] md:max-w-[800px] ${classNamePara} mx-auto md:text-[40px] lg:text-[50px] leading-[40px] md:leading-[50px] lg:leading-[55px] font-['Archivo'] text-secondary font-semibold home-section-headings`}>

                ...
                <div className='flex flex-col lg:flex-row w-full lg:items-center justify-between sm:space-y-6 lg:space-y-0'>
                    ...
                    <div className='lg:w-1/2 space-y-8 relative lg:bottom-8 py-14 lg:py-0'>
                        <div className=' xl:w-[80%] flex flex-col gap-4 lg:gap-12'>
                            <h2 className='text-[30px] md:text-[35px] lg:w-[600px] xl:text-[48px] font-["Archivo"] md:leading-10 xl:leading-[55px] flex flex-col text-secondary font-semibold home-section-headings'>Top Notch ERP Consulting and Implementation Services</h2>

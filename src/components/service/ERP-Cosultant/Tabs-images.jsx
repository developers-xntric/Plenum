          ...
          <div className="bg-primary font-['Archivo'] text-white p-3 md:p-5 absolute flex flex-col justify-start items-start left-0 bottom-0 w-[400px]">
            <div className="flex items-center gap-3">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <foreignObject x="0.9375" y="-3.75" width="38.125" height="43.9219"><div xmlns="http://www.w3.org/1999/xhtml" style={{ "backdropFilter": "blur(3.12px);clip-path:url(#bgblur_0_2402_5242_clip_path);height:100%;width:100%" }}></div></foreignObject><g data-figma-bg-blur-radius="6.25">

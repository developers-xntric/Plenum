    ...
    return (
        <section className="py-10 lg:py-10 lg:px-16 2xl:max-w-[1440px] font-['Archivo'] max-w-[90%] mx-auto">
            <div className="text-center mb-8 md:mb-12">
                <h2 className="text-[30px] lg:text-[50px] text-secondary font-semibold home-section-headings leading-[34px] lg:leading-[40px]">Impact of Dynamics 365 Finance and Operations</h2>

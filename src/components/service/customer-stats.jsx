export default function CustomerStats() {
    return (
        <section className="w-full py-12 md:py-16">
            <div className="2xl:max-w-[1440px] h-full w-[90%] mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
                        ...
                        <div className="text-center">
                            <p className="text-4xl md:text-5xl text-secondary mb-1">24K</p>
                            <p className="text-sm uppercase tracking-wider text-gray-600">Trusted Reviews</p>
                        </div>

                        {/* Stat 2 */}
                        <div className="text-center">
                            <p className="text-4xl md:text-5xl text-secondary mb-1">96%</p>
                            <p className="text-sm uppercase tracking-wider text-gray-600">Customer Satisfaction</p>
                        </div>

                        {/* Stat 3 */}
                        <div className="text-center">
                            <p className="text-4xl md:text-5xl text-secondary mb-1">32K</p>

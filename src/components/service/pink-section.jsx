        ...
        <div className={`bg-[#EFEFEF] md:h-[280px] ${className}`}>
            <div className='2xl:max-w-[1440px] h-full w-[90%] z-20 mx-auto space-y-20 py-16 relative'>
                ...
                <div className='md:w-[720px] xl:w-[913px] mx-auto my-auto h-[141px]'>
                    <h2 className='text-secondary text-[30px] md:text-[32px] lg:text-4xl xl:text-[45px] font-["Archivo"] text-center leading-[34px] md:leading-[55px] font-semibold home-section-headings'>{heading}</h2>

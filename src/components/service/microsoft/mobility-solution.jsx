...
export default function MobilitySolutions({
  ...
  return (
    <section className="md:pb-16 pb-20 py-20 max-w-[90%] 2xl:max-w-[1440px] font-['Archivo'] mx-auto">
      ...
      {isMobile ? (
        ...
        // Desktop grid view
        <div className={`${className} gap-5 xl:gap-8 2xl:gap-[30px] md:mt-14`}>
          {solutions.map((solution, index) => (
            <div
              key={index}
            ...
            >
              <Image
                ...
                className="w-10 h-10"
              />
              <h3 className="text-[20px] font-semibld text-sceondary lg:min-h-12">{solution.title}</h3>
